...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.ui_selector_bg_slingtab;
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            updateTabStyles();// add by TomkeyZhang
            if (delegatePageListener != null) {
    ...
    public void setSelectedTextColorResource(int selectedTextColorResId) {
        this.selectedTextColor = getContext().getResources().getColor(selectedTextColorResId);
        updateTabStyles();
    }
}
